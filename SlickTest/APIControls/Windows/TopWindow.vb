...
Friend Class TopWindow
    ...
    Public Shared Function GetCurrentlyActiveWindowHandle() As IntPtr
    ...
    Public Function ShowWindow(ByVal hWnd As IntPtr) As Boolean
        If (IsIconic(hWnd)) Then 'IsIconic = is minimized
            Return ShowWindow(hWnd, WindowShowStyle.Restore)
        Else
            If (IsZoomed(hWnd) = True) Then 'IsZoomed = is maximized.
                Return ShowWindow(hWnd, WindowShowStyle.ShowMaximized)
            Else
    ...
    End Function
    'IsIconic = is minimized
    Friend Declare Auto Function IsIconic Lib "user32.dll" (ByVal hwnd As IntPtr) As Boolean
    'IsIconic = is maximized

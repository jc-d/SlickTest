...
#Region "Constructor"
    ...
    Protected Friend Overrides Sub Init()
        HtmlTags = APIControls.WebTagDefinitions.DivTags
    End Sub
#End Region

    Private Function GetDivAPI() As WebDivAPI
        Return New WebDivAPI(Me.CurrentElement)
    End Function
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function GetNoWrap() As Boolean
        ExistsWithException()
        Return GetDivAPI().IsNoWrap()
    End Function

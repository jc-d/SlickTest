...
#Region "Constructor"
    ...
    Protected Friend Overrides Sub Init()
        HtmlTags = APIControls.WebTagDefinitions.ListItemTags
    End Sub
#End Region

    Private Function GetWebListItemAPI() As WebListItemAPI
        Return New WebListItemAPI(Me.CurrentElement)
    End Function

    Public Function GetItemType() As String
        ExistsWithException()
        Return GetWebListItemAPI.Type
    End Function

    Public Function GetListValue() As Integer
        ExistsWithException()
        Return GetWebListItemAPI.LIValue
    End Function
End Class

''' <summary>
''' A ListView is just a specialized WinObject, and so it performs everything a WinObject does.
''' </summary>
''' <remarks></remarks>
...
#End Region
    ...
    'Taken from for future usage:
    ' http://svn.openqa.org/fisheye/browse/pywinauto/trunk/pywinauto/controls/common_controls.py?r=691
    '              #-----------------------------------------------------------  
